...
This version stores everything in memory only. When you close the program, all your data will be lost. This is a simple learning project to understand how finance tracking apps work.